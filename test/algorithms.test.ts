...
describe("Algorithms Check", () => {
  it("should return the correct algorithm name", () => {
    ...
    strictEqual(CWTAlgorithms.toName(CWTAlgorithms.PS256), "PS256");
    strictEqual(CWTAlgorithms.toName(CWTAlgorithms.PS384), "PS384");
    strictEqual(CWTAlgorithms.toName(CWTAlgorithms.PS512), "PS512");
    strictEqual(CWTAlgorithms.toName(CWTAlgorithms.RS256), "RS256");
    strictEqual(CWTAlgorithms.toName(CWTAlgorithms.RS384), "RS384");
    strictEqual(CWTAlgorithms.toName(CWTAlgorithms.RS512), "RS512");
